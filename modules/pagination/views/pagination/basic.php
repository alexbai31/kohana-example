...
<ul>
	...
	<?php else: ?>
		<li><a href="javascript:void(0);" style="color:black;"><?php echo __('First') ?></a></li>
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<li><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Previous') ?></a></li>
	<?php else: ?>
		<li><a href="javascript:void(0);" style="color:black;"><?php echo __('Previous') ?></a></li>
	<?php endif ?>

	<?php for ($i = 1; $i <= $total_pages; $i++): ?>

		<?php if ($i == $current_page): ?>
			<li><a href="javascript:void(0);" style="color:black;"><strong><?php echo $i ?></strong></a></li>
		<?php else: ?>
	...
	<?php else: ?>
		<li><a href="javascript:void(0);" style="color:black;"><?php echo __('Next') ?></a></li>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<li><a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('Last') ?></a></li>
	<?php else: ?>
		<li><a href="javascript:void(0);" style="color:black;"><?php echo __('Last') ?></a></li>
	<?php endif ?>
</ul>
</div><!-- .pagination -->